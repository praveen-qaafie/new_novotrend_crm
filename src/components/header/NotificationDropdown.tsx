        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute -right-[240px] z-50 mt-[17px] flex w-[350px] flex-col rounded-2xl border border-gray-200 bg-white shadow-xl sm:w-[361px] lg:right-0 dark:border-gray-800 dark:bg-gray-900"
            >
              {/* Header */}
