...
//       dob: data.dob,
//       bio: data.bio ?? "",
//       mobileno: data.phone, // FIX: was missing — caused "Invalid mobile number"
...
//                   {/* Contact Info — from API keys */}
//                   <div>
//                     <h4 className="mb-2 font-medium text-gray-700 dark:text-gray-200">
//                       Contact Info
//                     </h4>
//                     <p className="text-sm text-gray-500">📧 {profileData?.user_reg_code ?? "—"}</p>
//                     <p className="text-sm text-gray-500">📱 {profileData?.user_mobile ?? "—"}</p>
//                   </div>

//                   {/* About */}
//                   <div>
//                     <h4 className="mb-2 font-medium text-gray-700 dark:text-gray-200">About</h4>
...
//                         {/* Phone Number — FIX: now properly registered */}
//                         <div>
//                           <label className="text-sm text-gray-500">
